...
nohup $SPARK_HOME/bin/spark-submit --driver-java-options "-Dlog4j.configuration=file://$REDROCK_HOME/conf/log4j.properties" --driver-memory 1g --master spark://$HOSTNAME:7077 --class com.restapi.Application $REDROCK_HOME/rest-api/target/scala-2.10/redrock-rest-api.jar > $REDROCK_HOME/rest-api/nohup-restapi.out&
