...
object ExecuteSentimentAnalysis {
  ...
  def runSentimentAnalysis(includeTerms: String, excludeTerms: String, top: Int,
                           startDatetime: String, endDatetime: String,
                           sentiment: Int, user: String): String = {
  ...
  def runTopicModel(includeTerms: String, excludeTerms: String, top: Int,
                    startDatetime: String, endDatetime: String, sentiment: Int): String = {
    try {
      ...
      val rawTextRDD = ApplicationContext.sparkContext.makeRDD(getTweetsText(includeTerms,
        excludeTerms, top, startDatetime, endDatetime, sentiment))
  ...
  def getTweetsText(includeTerms: String, excludeTerms: String, top: Int, startDatetime: String,
                    endDatetime: String, sentiment: Int): List[String] = {
    val elasticsearchRequests = new GetElasticsearchResponse(top,
      includeTerms.toLowerCase().trim().split(","),
      excludeTerms.toLowerCase().trim().split(","), startDatetime,
      endDatetime, LoadConf.esConf.getString("decahoseIndexName"))
    val tweets = (Json.parse(elasticsearchRequests.getSentimentWordAnalysis(sentiment)) \ "hits" \ "hits").as[List[JsObject]] // scalastyle:ignore
